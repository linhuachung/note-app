...
function FolderList({folders}) {
    ...
    useEffect(() => {updateFolderList(foldersSort).then(r => {
        console.log(r)})}, [foldersSort])

    return (
        <DroppableComponent itemSort={foldersSort} setItemSort={setFoldersSort} droppableId={'folder'} sx={{
            width: '100%',
            bgcolor: '#7D9D9C',
            height: '100%',
            padding: '10px',
